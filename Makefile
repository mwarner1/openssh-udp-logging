...
CC=cc -mt -fast
LD=cc -mt -fast
CFLAGS=-m64 -KPIC -xtarget=sparc64vi -xcache=128/64/2:5120/256/10 -xarch=sparcvis -xO5 -I/opt/openssl-0.9.8x/include -I/usr/include 
CPPFLAGS=-I. -I$(srcdir) -I/opt/openssl-0.9.8x/include -m64 -KPIC -xtarget=sparc64vi -xcache=128/64/2:5120/256/10 -xarch=sparcvis -xO5 -I/opt/openssl-0.9.8x/include -I/usr/include $(PATHS) -DHAVE_CONFIG_H
LIBS=-lresolv -lcrypto -lrt -lz -lsocket -lnsl 
SSHLIBS=
SSHDLIBS= -lpam -ldl
LIBEDIT=
AR=/usr/ccs/bin/ar
...
LDFLAGS=-L. -Lopenbsd-compat/ -L/opt/openssl-0.9.8x/lib -R/opt/openssl-0.9.8x/lib -m64 -xtarget=sparc64vi -xcache=128/64/2:5120/256/10 -L/opt/openssl-0.9.8x/lib -R/opt/openssl-0.9.8x/lib -L/opt/local/lib/64 -R/opt/local/lib/64
EXEEXT=
...
LIBSSH_OBJS=acss.o authfd.o authfile.o bufaux.o bufbn.o buffer.o \
	...
	log.o udplog.o match.o md-sha256.o moduli.o nchan.o packet.o \
...
PATHSUBS	= \
	...
	-e 's|/usr/bin:/bin:/usr/sbin:/sbin|/usr/bin:/bin:/usr/sbin:/sbin:/opt/local/bin|g'
